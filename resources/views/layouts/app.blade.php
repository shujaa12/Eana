    ...
    <head>
        ...
        <style>
            ...
            *{
            ...
            body, h1, h2, h3, h4 , tr, td,li, .block ,label, .page-title, .panel-title, .uppercase, .modal-title, .label{
                font-family: Tajawal;
            }
                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user dropdown-dark">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" class="img-circle" src="{{asset('uploads/user.png')}}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 footer-block">
                        ...
                        <address class="margin-bottom-40" style="float: right"> جوال: <a href="tel:+966 55 786 9291">9291 786 55 966+</a>
                            <br> إيميل:
                            <a href="mailto:info@subvention.com">info@subvention.com</a>
                        </address>
                    </div>
                </div>
            </div>
