    ...
    <div class="col-md-8">
        ...
        <li class="menu-dropdown classic-menu-dropdown ">
            ...
            <ul class="dropdown-menu" class="Tajawal">
                <li class="Tajawal">
                    <a href="/Donations" class="nav-link" style="font-family: Tajawal !important;">
                    المنتجات (التبرعات)
                    </a>
                </li>
                <li class="Tajawal">
                    <a href="/MyDonations" class="nav-link" style="font-family: Tajawal !important;">
        ...
        <li class="menu-dropdown classic-menu-dropdown ">
            ...
            <ul class="dropdown-menu" class="Tajawal">
                <li class="Tajawal">
                    <a href="/MyOrders" class="nav-link" style="font-family: Tajawal !important;">
                           طلباتي
                    </a>
                </li>
                <li class="Tajawal">
                    <a href="/Orders" class="nav-link" style="font-family: Tajawal !important;">
