...
class MessengerController extends Controller
{
    ...
    public function index()
    {
        ...
        $messages1 = DB::table('countmassage_es')
        ->Where('sender',  -1)
        ->Where('receiver', $userId)
        ->get();


        $messages2 = DB::table('countmassage_es')
        ->Where('receiver', $userId)
...
$messages_count = DB::table('countmassage2_es')->where('receiver', $id)->first();
if (is_null($messages_count)) {
  $messages_count = 0;
}
else{
  $messages_count = $messages_count->countMas;
}
$data = array(
'messages' => $messages,
...
foreach ($messages_es as  $value) {
 if ($value->sender != $receiver) {
   ...
   <img class="todo-userpic pull-left" src="uploads/users.jpg" width="27px" height="27px">
...
$data01 = $data01 .' </div></div>';
       ...
       '<div class="todo-tasklist-item">
                 <img class="todo-userpic pull-right" src="uploads/users.jpg" width="27px" height="27px">
